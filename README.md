...
- **Hybrid by choice** — plug in external LLM APIs per node when local is not enough.
...
Some work should not ride on someone else's server: client documents, unreleased designs, internal numbers. MYNERD's default is your GPU, your disk, your rules — with a clean escape hatch to cloud APIs when a job needs a bigger brain.
